//首页控制器
app.controller('orderTypeController',function($scope,loginService,$http){
    ...
    $scope.findPage = function (page, rows) {
        $http.post("../userOrders/showOrdersByStatus.do?username="+$scope.loginName+"&pageNum="+$scope.paginationConf.currentPage+"&pageSize="+$scope.paginationConf.itemsPerPage+"&status="+$scope.flage).success(
            function (response) {
